                ...
                <view className="MainContent">
                    <view className="Header">
                        <view style="display:flex;flex-direction:row;align-items:center;justify-content:space-between">
                            <text className="Title">Movies Mania</text>
                        </view>
                                ...
                                return (
                                    ...
                                    >
                                        <view
                                            ...
                                            className={
                                                index % 2 === 0
                                                    ? "ItemBgOdd ItemBgCommon"
                                                    : "ItemBgEven ItemBgCommon"
                                        ...
                                        >
                                            ...
                                            <view className="MovieInfo">
                                                ...
                                                <text className="MovieDate">
                                                    <text className="MovieDate" style={{fontWeight:'600'}}>Release Date:{" "}</text>
                                                    {movie.release_date}
                                                </text>
                                                <text className="MovieGenres">
                                                    <text className="MovieDate" style={{fontWeight:'600'}}>Genres:{" "}</text>
                                                    {getGenreNames(
                                                        movie.genre_ids
                                                    )}
                                                </text>
